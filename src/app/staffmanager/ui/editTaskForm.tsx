...
import { StaffWithShifts, StaffWithTasks } from "@/models/staff";
import {
  Select,
  SelectContent,
  SelectGroup,
...
import { onUpdateTask } from "../actions/onupdatetask";
...
export function EditTaskForm({
  ...
  const [state, formAction, pending] = useActionState(submitEdit, initialState);
  useEffect(() => {
  ...
  async function submitEdit(
    ...
    try {
        formData.append("task_id", staff.staff_tasks!.task_id || "");
        formData.append("staff_id", staff.staff_id || "");
      
      const response = await onUpdateTask(formData);
      if (response.success) {
        return { success: true, messages: ["Task updated successfully"] };
      } else {
    ...
    <DialogContent className="sm:max-w-[600px]">
      ...
      <form action={formAction} className="space-y-6 p-6">
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <div className="col-span-3">
            <DatePicker 
              ...
              name="date" 
              defaultValue={new Date(staff.staff_tasks!.deadline)}
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <div className="col-span-3">
            <Select name="priority" defaultValue={staff.staff_tasks!.priority}>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <div className="col-span-3">
            <Select name="status" defaultValue={staff.staff_tasks!.status}>
              <SelectTrigger className="w-full border-gray-300 rounded-lg">
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <div className="col-span-3">
            <Input
              ...
              defaultValue={staff.staff_tasks!.title}
              required
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <div className="col-span-3">
            <textarea
              ...
              defaultValue={staff.staff_tasks!.description}
              required
            />
          </div>
        </div>
        ...
        <DialogFooter className="flex justify-between">
          ...
          <Button
            type="submit"
            className="rounded-lg py-2 flex items-center justify-center disabled:opacity-50"
          >
