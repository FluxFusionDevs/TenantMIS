  ...
  const createReportButton = [
    {
      ...
      content: (
        <div>
            <h1 className="text-2xl font-medium">Create Revenue Report</h1>
    ...
    },
    {
        ...
        content: (
          <div>
              <h1 className="text-2xl font-medium">Create Expense Report</h1>
              <p className="text-muted-foreground">Generate a report based on total expenses during an allotted time</p>
          </div>
        )
...
export default function Page() {
    return (
      <div className="space-y-4">
        <h1 className="text-3xl font-bold opacity-80">Report Management</h1>
        <h2 className="text-2xl font-semibold text-muted-foreground">Recent Reports</h2>

        <div className="overflow-x-auto whitespace-nowrap">
        <MultiCard data={cardData} direction="row"/>
        </div>

        <h2 className="text-2xl font-semibold text-muted-foreground">Create Reports</h2>
